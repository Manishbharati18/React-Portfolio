    ...
    <>
     <StyledNamespace animate={controls} ref={ref} id="about" variants={slideAnim.right}>
        ...
        <p>
            ...
            <Class>
                <span>public class</span> Manish Bharati : Person<br />
                &#123; <br/>
                <Properties>
                    <span>public int</span>  Age &#123; get; &#125; = 21;<br/>
                    <span>public string</span> City &#123; get; &#125; = "Deoria";<br/>
                    <span>public string</span> Studying &#123; get; &#125; = "Institute of Engineering and Technology Ayodhya";<br/>
                </Properties>
                &#125;
            </Class>
        &#125;
